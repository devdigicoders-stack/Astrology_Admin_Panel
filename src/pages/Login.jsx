...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await authService.loginAdmin(credentials.email.trim(), credentials.password);
      
      if (response.success) {
        setLoginData({ ...response.admin, token: response.token });
    ...
    >
      ...
      >
        ...
        <div className="text-center ">
          <div className="w-full h-40 mx-auto flex items-center justify-center p-1">
            <img
              src="/logo.png"
              alt="Astrology Logo"
