      ...
      >
        <div className="flex items-center min-w-0 flex-1">
          ...
          <div className="hidden sm:flex flex-col ml-2">
            <h2
              className="text-sm sm:text-base font-bold truncate tracking-wide"
              style={{
            ...
            <p className="text-xs hidden sm:block mt-0.5 opacity-80" style={{ color: themeColors.textSecondary }}>
              Your cosmic command center is ready. 🌟
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 mr-2">
          ...
          <Link
            to="/notifications"
            className="p-2 rounded-md border hover:scale-105 transition-all duration-300 group flex items-center justify-center relative"
            style={{
              backgroundColor: themeColors.background,
              color: themeColors.text,
              borderColor: themeColors.border,
            ...
            title="Notifications"
          >
            <FaBell className="text-lg" style={{ color: themeColors.primary }} />
          ...
          <Link
            to="/profile"
            className="px-4 py-1.5 rounded-md border hover:scale-105 transition-all duration-300 group flex items-center justify-center gap-2"
            style={{
              backgroundColor: themeColors.background,
              color: themeColors.text,
              borderColor: themeColors.border,
          ...
          >
            ...
            <span className="font-semibold text-sm hidden sm:block">{admin?.name || "Admin"}</span>
          </Link>
        </div>
